...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT_65_ansi(
        ...
        TO(_WL), KC_MPLY, KC_VOLU, KC_MUTE,    KC_BRID, KC_BRIU, _______, _______, _______, _______, G(C(S(KC_4))), _______, _______, _______, _______,
    ...
    [_FL] = LAYOUT_65_ansi(
        KC_ESC,    KC_F1,   KC_F2,   KC_F3,      KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,        KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_INS,
        TO(_BL), KC_MPLY, KC_VOLU, KC_MUTE,    KC_BRID, KC_BRIU, _______, _______, _______, _______,    G(S(KC_S)), _______, _______, _______, _______,
          RESET, KC_MPRV, KC_VOLD, KC_MNXT, C(G(KC_F)), _______, _______, _______, _______, _______,       _______, _______,          _______, _______,
        _______,          _______, _______,    _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______,
